            ...
            <div className="text-center">
              ...
              <div className="flex items-center justify-center mb-4">
                ...
                <span className="text-xl text-gray-700 font-medium">
                  Classe : {gradeLabels[currentUser.grade] || currentUser.grade.toUpperCase()}
                </span>
              </div>
          ...
          {loading ? (
            <div className="flex items-center justify-center py-16">
              <div className="text-center">
                ...
                <p className="text-gray-600 text-lg">Chargement de vos matières...</p>
              </div>
            </div>
          ) : subjects.length === 0 ? (
            /* Aucune matière */
            <div className="text-center py-16">
              <div className="bg-white/60 backdrop-blur-sm rounded-3xl p-12 shadow-lg border border-white/20">
                ...
                <p className="text-gray-600 max-w-md mx-auto">
                  Il semble qu'aucune matière n'ait encore été créée pour votre classe. 
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
              {subjects.map((subject) => {
                ...
                return (
                  <div
                    key={subject.id}
                    className="group bg-white/60 backdrop-blur-sm rounded-3xl p-6 shadow-lg border border-white/20 hover:shadow-2xl hover:scale-105 transition-all duration-300 cursor-pointer"
